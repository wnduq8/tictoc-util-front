...
type CustomSubmitFn<T extends string> = (values: Record<T, string>, e: React.FormEvent<HTMLFormElement>) => void
type HandleSubmitFn<T extends string> = (onSubmit: CustomSubmitFn<T>) => (e: React.FormEvent<HTMLFormElement>) => void
